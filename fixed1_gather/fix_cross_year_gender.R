...
# 2401
pdf("./fix_first/face_level_barplot.pdf",width = 12)
for(i in v2){
  p1 <- ggplot(boxsub3_core_frame, aes(x = .data[[i]], fill = .data[["right_level"]])) +
    geom_bar(position = "fill") + theme_classic() + 
    myggtitle(boxsub3_core_frame[[i]], boxsub3_core_frame[["right_level"]]) +
    facet_grid(xingbie_level ~  NL_level)
    
  p2 <- ggplot(boxsub3_core_frame, aes( x = .data[[i]], fill = .data[["left_level"]])) +
    geom_bar(position = "fill") + theme_classic() + 
    myggtitle(boxsub3_core_frame[[i]], boxsub3_core_frame[["left_level"]]) +
    facet_grid(xingbie_level ~  NL_level)
  
  p3 <- ggplot(boxsub3_core_frame, aes(x = .data[[i]], fill = .data[["max_level"]])) +
    geom_bar(position = "fill") + theme_classic() + 
    myggtitle(boxsub3_core_frame[[i]], boxsub3_core_frame[["max_level"]]) +
    facet_grid(xingbie_level ~  NL_level)
  print(p1 / p2 / p3)
}
dev.off()

pdf("./fix_first/face_count_level_barplot.pdf",width = 12)
for(i in v2){
  p1 <- ggplot(boxsub3_core_frame, aes(x = .data[[i]], fill = .data[["right_level"]])) +
...
# 2382
pdf("./fix_first/face_zhifanggan_level_barplot.pdf",width = 12)
i = v2
...
pdf("./fix_first/face_zhifanggan_level_barplot_count.pdf",width = 12)
i = v2
p1 <- ggplot(boxsub3x_core_frame, aes(x = .data[[i]], fill = .data[["right_level"]])) +
...
boxsub3_core_frame$max_level <- factor(boxsub3_core_frame$max_level, levels = c("normal", "level1", "level2" ))
# 2401
pdf("./fix_first/face_thin_level_barplot.pdf",width = 12)
for(i in v2){
...
pdf("./fix_first/face_count_thin_level_barplot.pdf",width = 12)
for(i in v2){
  p1 <- ggplot(boxsub3_core_frame, aes(x = .data[["right_level"]], fill = .data[[i]] %>% as.character())) +
    geom_bar() + theme_classic() + 
    myggtitle(boxsub3_core_frame[[i]], boxsub3_core_frame[["right_level"]]) +
...
boxsub3x_core_frame$max_level <- factor(boxsub3x_core_frame$max_level, levels = c("normal", "level1", "level2" ))
# 2382
pdf("./fix_first/face_zhifanggan_thin_level_barplot.pdf",width = 12)
i = v2
...
pdf("./fix_first/face_zhifanggan_thin_level_barplot_count.pdf",width = 12)
i = v2
p1 <- ggplot(boxsub3x_core_frame, aes(x = .data[["right_level"]], fill = .data[[i]] %>% as.character())) +
  geom_bar() + theme_classic() + myggtitle(boxsub3x_core_frame[[i]], boxsub3x_core_frame[["right_level"]]) + 
  facet_grid(xingbie_level ~  NL_level) + 
...
pdf("./fix_first/face_boxplot.pdf", height = 12, width = 16)
for(i in ic){
...
pdf("./fix_first/face_boxplotx.pdf", height = 12, width = 16)
